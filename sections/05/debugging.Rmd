...
A couple hints to help get started 
  - Use `debug(logitBoot)` to step through the function.  Determine which entry/entries in `out` are particuarily large or small.  
