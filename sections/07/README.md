...
You will also need Python and Jupyter Notebook installed on your computer, as well as a few core additional packages, including numpy, scipy, and pandas.  Instead of Jupyter Notebook you are free to use IPython, although I have set up a Python notebook with the code from the tutorital ready to run, so I would suggest using Jupyter to save some time.  

To get started you will need to install Python on your system.  I suggest using the Anaconda installation of Python if you do not already have Python on your computer.  Detailed installation instructions for [MacOS](https://www.datacamp.com/community/tutorials/installing-anaconda-mac-os-x ) and [Ubuntu](https://phoenixnap.com/kb/how-to-install-anaconda-ubuntu-18-04-or-20-04) can be found at those links.  For more information you can look at the 
